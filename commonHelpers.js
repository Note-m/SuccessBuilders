        ...
        <div class="my-projects-name-btn">
          ...
          <a
            ...
            >VISIT<svg class="my-projects-icon" width="18" height="18">
              <use href="${m}#my-projects-arrow"></use>
            </svg></a>
        </div>
      </li>`).join("");Z.insertAdjacentHTML("beforeend",i),u+=k}u>=w.length&&x.classList.add("is-hidden")};x.addEventListener("click",K);const q=document.querySelector(".switch-btn"),L=t=>{q.classList.toggle("dark-on"),document.body.classList.toggle("body-dark");const s=document.querySelectorAll(".use-acardion"),i=document.querySelectorAll(".up-line-icon"),e=document.querySelectorAll(".down-line-icon");s.forEach(r=>{let o;document.body.classList.contains("body-dark")?o="faq-arrow-white-down-icon":o="faq-arrow-down-icon",r.setAttribute("href",`${m}#${o}`)}),e.forEach(r=>{let o;document.body.classList.contains("body-dark")?o="tech-skills-dark-white-square-icon":o="tech-skills-black-square-icon",r.setAttribute("href",`${m}#${o}`)}),i.forEach(r=>{let o;document.body.classList.contains("body-dark")?o="tech-skills-dark-green-square-icon":o="tech-skills-green-square-icon",r.setAttribute("href",`${m}#${o}`)})};q.addEventListener("click",L);document.addEventListener("DOMContentLoaded",()=>{L()});j();M();L();
